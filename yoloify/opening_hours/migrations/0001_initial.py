...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'opening_hours_openinghours', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('goal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pinboard.Goal'])),
        ...
        db.send_create_signal(u'opening_hours', ['OpeningHours'])


    def backwards(self, orm):
        # Deleting model 'OpeningHours'
        db.delete_table(u'opening_hours_openinghours')
    ...
    models = {
        ...
        u'opening_hours.openinghours': {
            'Meta': {'ordering': "('weekday', 'from_hour')", 'object_name': 'OpeningHours'},
            'from_hour': ('django.db.models.fields.TimeField', [], {}),
            'goal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pinboard.Goal']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
