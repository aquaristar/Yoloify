...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pinboard_temporaryimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('created', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'pinboard', ['TemporaryImage'])


        # Changing field 'Goal.title'
        db.alter_column(u'pinboard_goal', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        # Deleting model 'TemporaryImage'
        db.delete_table(u'pinboard_temporaryimage')


        # Changing field 'Goal.title'
        db.alter_column(u'pinboard_goal', 'title', self.gf('django.db.models.fields.CharField')(max_length=180))
