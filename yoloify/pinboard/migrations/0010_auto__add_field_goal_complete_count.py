...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Goal.complete_count'
        db.add_column(u'pinboard_goal', 'complete_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Goal.complete_count'
        db.delete_column(u'pinboard_goal', 'complete_count')
