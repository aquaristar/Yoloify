...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Goal.dominant_color'
        db.add_column(u'pinboard_goal', 'dominant_color',
                      self.gf('django.db.models.fields.CharField')(default='FFFFFF', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Goal.dominant_color'
        db.delete_column(u'pinboard_goal', 'dominant_color')
