...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Like.start_valid'
        db.add_column(u'pinboard_like', 'start_valid',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 4, 24, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Like.end_valid'
        db.add_column(u'pinboard_like', 'end_valid',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Like.start_valid'
        db.delete_column(u'pinboard_like', 'start_valid')

        # Deleting field 'Like.end_valid'
        db.delete_column(u'pinboard_like', 'end_valid')
