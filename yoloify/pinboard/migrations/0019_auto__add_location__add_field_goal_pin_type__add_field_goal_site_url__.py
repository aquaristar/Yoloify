...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pinboard_location', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('address', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
            ('bounds', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
            ('place', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'pinboard', ['Location'])

        # Adding field 'Goal.pin_type'
        db.add_column(u'pinboard_goal', 'pin_type',
                      self.gf('django.db.models.fields.CharField')(default='goal', max_length=10),
                      keep_default=False)

        # Adding field 'Goal.site_url'
        db.add_column(u'pinboard_goal', 'site_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000),
                      keep_default=False)

        # Adding field 'Goal.category'
        db.add_column(u'pinboard_goal', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pinboard.LocationCategory'], null=True, on_delete=models.DO_NOTHING, blank=True),
                      keep_default=False)

        # Adding field 'Goal.hike_detail'
        db.add_column(u'pinboard_goal', 'hike_detail',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'Goal.location'
        db.add_column(u'pinboard_goal', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pinboard.Location'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Location'
        db.delete_table(u'pinboard_location')

        # Deleting field 'Goal.pin_type'
        db.delete_column(u'pinboard_goal', 'pin_type')

        # Deleting field 'Goal.site_url'
        db.delete_column(u'pinboard_goal', 'site_url')

        # Deleting field 'Goal.category'
        db.delete_column(u'pinboard_goal', 'category_id')

        # Deleting field 'Goal.hike_detail'
        db.delete_column(u'pinboard_goal', 'hike_detail')

        # Deleting field 'Goal.location'
        db.delete_column(u'pinboard_goal', 'location_id')
    ...
    models = {
        ...
        u'pinboard.goal': {
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pinboard.Location']", 'null': 'True', 'blank': 'True'}),
            'pin_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'pin_type': ('django.db.models.fields.CharField', [], {'default': "'goal'", 'max_length': '10'}),
            'site_url': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1000'}),
