...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Goal.image_author'
        db.add_column(u'pinboard_goal', 'image_author',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Goal.image_source'
        db.add_column(u'pinboard_goal', 'image_source',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Goal.image_author'
        db.delete_column(u'pinboard_goal', 'image_author')

        # Deleting field 'Goal.image_source'
        db.delete_column(u'pinboard_goal', 'image_source')
