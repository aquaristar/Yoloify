...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Like'
        db.delete_table(u'pinboard_like')

    def backwards(self, orm):
        # Adding model 'Like'
        db.create_table(u'pinboard_like', (
            ('goal', self.gf('django.db.models.fields.related.ForeignKey')(related_name='likes', to=orm['pinboard.Goal'])),
            ('start_valid', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='likes', to=orm['auth.User'])),
            ('end_valid', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'pinboard', ['Like'])
