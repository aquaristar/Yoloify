...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Pin', fields ['end_valid', 'goal', 'user']
        db.delete_unique(u'pinboard_pin', ['end_valid', 'goal_id', 'user_id'])

        # Deleting field 'Pin.completed'
        db.delete_column(u'pinboard_pin', 'completed')

        # Deleting field 'Pin.end_valid'
        db.delete_column(u'pinboard_pin', 'end_valid')

        # Deleting field 'Pin.start_valid'
        db.delete_column(u'pinboard_pin', 'start_valid')

        # Adding unique constraint on 'Pin', fields ['goal', 'user']
        db.create_unique(u'pinboard_pin', ['goal_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Pin', fields ['goal', 'user']
        db.delete_unique(u'pinboard_pin', ['goal_id', 'user_id'])

        # Adding field 'Pin.completed'
        db.add_column(u'pinboard_pin', 'completed',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Pin.end_valid'
        db.add_column(u'pinboard_pin', 'end_valid',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Pin.start_valid'
        db.add_column(u'pinboard_pin', 'start_valid',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 1, 7, 0, 0), blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Pin', fields ['end_valid', 'goal', 'user']
        db.create_unique(u'pinboard_pin', ['end_valid', 'goal_id', 'user_id'])
