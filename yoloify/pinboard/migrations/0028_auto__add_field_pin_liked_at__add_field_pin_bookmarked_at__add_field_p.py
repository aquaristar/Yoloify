...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pin.liked_at'
        db.add_column(u'pinboard_pin', 'liked_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Pin.bookmarked_at'
        db.add_column(u'pinboard_pin', 'bookmarked_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Pin.complete_at'
        db.add_column(u'pinboard_pin', 'complete_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pin.liked_at'
        db.delete_column(u'pinboard_pin', 'liked_at')

        # Deleting field 'Pin.bookmarked_at'
        db.delete_column(u'pinboard_pin', 'bookmarked_at')

        # Deleting field 'Pin.complete_at'
        db.delete_column(u'pinboard_pin', 'complete_at')
