...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('city', (
            ...
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cities', null=True, to=orm['pinboard.Location'])),
            ('visible', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'pinboard', ['City'])

        # Adding model 'CityCategory'
        db.create_table('city_category', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('meta_title', self.gf('django.db.models.fields.CharField')(max_length=68, null=True, blank=True)),
            ('meta_description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('meta_keywords', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pinboard.LocationCategory'])),
            ('thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('order', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('visible', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'pinboard', ['CityCategory'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CityCategory'
        db.delete_table('city_category')
