...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'City.radius'
        db.add_column('city', 'radius',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=15),
                      keep_default=False)

        # Adding field 'City.order'
        db.add_column('city', 'order',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'City.radius'
        db.delete_column('city', 'radius')

        # Deleting field 'City.order'
        db.delete_column('city', 'order')
