...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Goal.deal_button_link'
        db.add_column(u'pinboard_goal', 'deal_button_link',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Goal.deal_button_link'
        db.delete_column(u'pinboard_goal', 'deal_button_link')
