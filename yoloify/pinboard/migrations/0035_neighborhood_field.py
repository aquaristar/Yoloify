...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.neighborhood'
        db.add_column(u'pinboard_location', 'neighborhood',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.neighborhood'
        db.delete_column(u'pinboard_location', 'neighborhood')
