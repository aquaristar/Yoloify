...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Goal.tag_line'
        db.add_column(u'pinboard_goal', 'tag_line',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Goal.features'
        db.add_column(u'pinboard_goal', 'features',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Goal.tag_line'
        db.delete_column(u'pinboard_goal', 'tag_line')

        # Deleting field 'Goal.features'
        db.delete_column(u'pinboard_goal', 'features')
    ...
    models = {
        ...
        u'pinboard.goal': {
            ...
            'tag_line': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
