...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Goal.tag_line'
        db.alter_column(u'pinboard_goal', 'tag_line', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'Goal.tag_line'
        db.alter_column(u'pinboard_goal', 'tag_line', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'pinboard.goal': {
            ...
            'tag_line': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
