...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CityGetaway'
        db.create_table('city_getaway', (
        ...
        db.send_create_signal(u'pinboard', ['CityGetaway'])


    def backwards(self, orm):
        # Deleting model 'CityGetaway'
        db.delete_table('city_getaway')
