...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CityGetaway.location'
        db.add_column('city_getaway', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='city_getaway', null=True, to=orm['pinboard.Location']),
                      keep_default=False)

        # Adding field 'CityGetaway.radius'
        db.add_column('city_getaway', 'radius',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CityGetaway.location'
        db.delete_column('city_getaway', 'location_id')

        # Deleting field 'CityGetaway.radius'
        db.delete_column('city_getaway', 'radius')
