...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CityGetawayList'
        db.create_table('city_getawaylist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('meta_title', self.gf('django.db.models.fields.CharField')(max_length=68, null=True, blank=True)),
            ...
            ('meta_heading', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('og_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pinboard.City'])),
            ('thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('visible', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'pinboard', ['CityGetawayList'])

        # Adding field 'CityGetaway.citygetawaylist'
        db.add_column('city_getaway', 'citygetawaylist',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='getaway_list', to=orm['pinboard.CityGetawayList']),
                      keep_default=False)


        # Changing field 'CityGetaway.city'
        db.alter_column('city_getaway', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pinboard.CityGetawayList']))

    def backwards(self, orm):
        # Deleting model 'CityGetawayList'
        db.delete_table('city_getawaylist')

        # Deleting field 'CityGetaway.citygetawaylist'
        db.delete_column('city_getaway', 'citygetawaylist_id')


        # Changing field 'CityGetaway.city'
        db.alter_column('city_getaway', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pinboard.City']))
    ...
    models = {
        ...
        u'pinboard.citygetaway': {
            'Meta': {'ordering': "['order']", 'object_name': 'CityGetaway', 'db_table': "'city_getaway'"},
            'city': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'getaway_city'", 'to': u"orm['pinboard.CityGetawayList']"}),
            'citygetawaylist': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'getaway_list'", 'to': u"orm['pinboard.CityGetawayList']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'city_getaway'", 'null': 'True', 'to': u"orm['pinboard.Location']"}),
            'meta_description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'meta_heading': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'meta_keywords': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'meta_title': ('django.db.models.fields.CharField', [], {'max_length': '68', 'null': 'True', 'blank': 'True'}),
        ...
        u'pinboard.citygetawaylist': {
            'Meta': {'object_name': 'CityGetawayList', 'db_table': "'city_getawaylist'"},
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pinboard.City']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meta_description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'pinboard.goal': {
            ...
            'deal_active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'deal_button_link': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            ...
            'tag_line': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
