...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CityGetaway.tag_line'
        db.add_column('city_getaway', 'tag_line',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)

        # Adding field 'CityGetaway.features'
        db.add_column('city_getaway', 'features',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'CityGetaway.description'
        db.add_column('city_getaway', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CityGetaway.tag_line'
        db.delete_column('city_getaway', 'tag_line')

        # Deleting field 'CityGetaway.features'
        db.delete_column('city_getaway', 'features')

        # Deleting field 'CityGetaway.description'
        db.delete_column('city_getaway', 'description')
